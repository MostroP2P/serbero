...
The following items were originally scoped as "Phase 5" but are now tracked as independent improvements rather than a formal roadmap phase:

- **Additional reasoning adapters**: Anthropic and PPQ.ai native adapters are tracked in [#38](https://github.com/MostroP2P/serbero/issues/38) and [#39](https://github.com/MostroP2P/serbero/issues/39).
- **Multi-operator coordination**: Research on routing disputes to specific operators from a pool is tracked in [#40](https://github.com/MostroP2P/serbero/issues/40).

These features may land incrementally without requiring a coordinated "phase" release.
...
| Reasoning backend unavailable  | Falls back to immediate operator escalation     |
