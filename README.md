...
| **PPQ.ai** (issue #39)                | `openai-compatible` | `https://api.ppq.ai`              | Aggregator that routes many models (`ppq/autoclaw`, `google/gemini-2.5-flash`, `claude-sonnet-4.6`, …) behind a single OpenAI-compatible `/chat/completions` path. Bare host — do NOT append `/v1`. |
